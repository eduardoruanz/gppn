...
impl DidManager {
    ...
    ///
    /// The DID format is: `did:veritas:<method>:<bs58_pubkey>`
    ///
    ...
    pub fn create_did(&self, method: &str, keypair: &KeyPair) -> Result<Did, IdentityError> {
        ...
        let did_uri = format!("did:veritas:{}:{}", method, pubkey_bs58);
...
mod tests {
    ...
    fn test_create_did() {
        ...
        assert!(did.uri().starts_with("did:veritas:key:"));
    ...
    fn test_create_did_format() {
        ...
        let expected_uri = format!("did:veritas:key:{}", expected_bs58);
    ...
    fn test_resolve_nonexistent_did() {
        let mgr = DidManager::new();
        assert!(mgr.resolve_did("did:veritas:key:nonexistent").is_none());
    }
    ...
    fn test_update_nonexistent_document() {
        let mgr = DidManager::new();
        let doc = DidDocument::new("did:veritas:key:fake".to_string(), "fake".to_string());
    ...
    fn test_different_methods() {
        ...
        assert!(did.uri().starts_with("did:veritas:web:"));
